...
ap.add_argument("-m", "--model", required=True, help="src/output")
args = vars(ap.parse_args())

#initilize the learning rate number of epochs and batch size
INIT_LR = 1e-3
EPOCHS = 10
BS = 128
...
# serialize the model to desk
print("[INFO] serializing degit model...")
